...
#define OBEX_OPP	(1 << 1)
#define OBEX_FTP	(1 << 2)
#define OBEX_BIP_PUSH	(1 << 9)
#define OBEX_BIP_PULL	(1 << 10)
#define OBEX_BIP_ARCH	(1 << 11)
#define OBEX_BIP_AOS	(1 << 12)
#define OBEX_BIP_RD	(1 << 13)
#define OBEX_BIP_RC	(1 << 14)
#define OBEX_BIP	(OBEX_BIP_PUSH | OBEX_BIP_PULL | OBEX_BIP_ARCH | OBEX_BIP_AOS | OBEX_BIP_RD | OBEX_BIP_RC )
